...
from routers import userService, enterpriseService, planingService
import auth
...
app.include_router(planingService.router, tags=["planings"])
...
async def initDatabase():
    ...
    planingService.planings = planingService.initPlanings()
